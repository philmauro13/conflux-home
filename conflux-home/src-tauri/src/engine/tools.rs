        ...
        serde_json::json!({
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "widget": { "type": "string", "description": "Widget to control. Values:\n- 'theme': 'dark' | 'light' | 'system', OR a color theme (conflux/⚡, nexus/🌐, hearth/🔥, pulse/💚, orbit/🛸, radar/📡, horizon/🌅, echo/🔔, aegis/🛡️, viper/🐍). Color themes set accent color + wallpaper. Example: value='pulse' or value='echo' or value='viper'.\n- 'accentColor': 'blue' | 'purple' | 'green' | 'orange' | 'pink' | 'cyan'\n- 'wallpaper': wallpaper URL\n- 'activeApp': 'dashboard' | 'kitchen' | 'budget' | 'life' | 'dreams' | 'echo' | 'vault' | 'home'\n- 'sidebar' | 'chat' | 'voiceChat' | 'controlRoom': 'toggle' | 'open' | 'close'\n- 'pushToTalk': 'toggle' | 'start' | 'stop'\n- 'barVersion': 'v1' | 'v2'" },
